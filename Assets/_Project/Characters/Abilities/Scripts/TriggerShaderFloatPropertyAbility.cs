...
namespace PF.PJT.Duet.Pawn.PawnAbility
{
    ...
    public class TriggerShaderFloatPropertyAbility : GASAbility
    {
        ...
        public class Spec : GASAbilitySpec, IUpdateableAbilitySpec
        {
            ...
            private void GameplayTagSystem_OnTriggeredTag(StudioScor.GameplayTagSystem.IGameplayTagSystem gameplayTagSystem, StudioScor.GameplayTagSystem.GameplayTag gameplayTag, object data = null)
            {
