...
namespace PF.PJT.Duet.UISystem
{
    ...
    public class CheckExitGameUI : BaseToolkitUI
    {
        public delegate void CheckExitGameUIStateEventHandler(CheckExitGameUI checkExitGameUI);
        ...
        public event CheckExitGameUIStateEventHandler OnAccepted;
        public event CheckExitGameUIStateEventHandler OnRejected;
