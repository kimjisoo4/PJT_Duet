...
{
    [AddComponentMenu("Duet/DialougeSystem/Display/States/Dialogue Display Leave State")]
    public class DialogueDisplayLeaveState : DialogueDisplayState
    {
        [Header(" [ Appear State ] ")]
        ...
        protected override void EnterState()
        {
            ...
            if (_sequence is null)
            {
                ...
                _sequence.Append(_fadeCanvas.DOFade(0f, _fadeDuration));
